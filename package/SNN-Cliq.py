# -*- coding: utf-8 -*-
"""
Download from https://github.com/charliex210/sctools/blob/master/inst/rpy/snncliq.py
...
#     path  ="//192.168.0.2\\d\\chenxingZhang\\case\\matrix_genePath\\three2labelK"
#     # name = "w_yan.rds_SNF_cluster_AUCell_K2_10"
#     name = "w_biase.rds_SNF_KEGG_AUCell_K2_8"
#     # name = 'w_baron-mouse.rds_SNF_Reactome_AUCell_K2'
#     data = load_W(path, name)
#     dmat = euclidean_distances(data)
#     aa = snn_cliq(dmat, 0.5, 0.9, 10)
#     bb = snn_cliq(dmat, 0.5, 0.1, 10)
#     cc = snn_cliq(dmat, 0.7, 0.9, 10)
#     print('')